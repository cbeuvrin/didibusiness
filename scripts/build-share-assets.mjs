...
const logo=`data:image/png;base64,${(await readFile('public/brand/los-didis-logo-white.png')).toString('base64')}`;
...
try{
 ...
 await page.screenshot({path:'public/brand/los-didis-share-v2.jpg',type:'jpeg',quality:90});
 for(const [size,name] of [[64,'favicon-white.png'],[180,'apple-touch-icon-white.png']]){
 ...
 await writeFile('public/brand/favicon.png',await readFile('public/brand/favicon-white.png'));
